          ...
          <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="<?= site_url('/services/update/' . $id)?>">
                      <div class="form-group">
                        <label for="exampleInputName1">Service Name</label>
                        <input type="text" name="title" value="<?= $title?>" class="form-control" id="exampleInputName1">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputCity1">Details</label>
                        <input type="text" name="details" value="<?= $details?>" class="form-control" id="exampleInputCity1">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputCity1">Price</label>
                        <input type="text" name="cost" value="<?= $cost?>" class="form-control" id="exampleInputCity1">
                      </div>
                      <div class="form-group">
