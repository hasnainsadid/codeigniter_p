                    ...
                    <tbody>
                      ...
                      foreach ($packages as $item) : ?>
                        <tr>
                          ...
                          <td> <?= $item['upload_path'] ?> </td>
                          <td> <?= ($item['status']) == 1 ? 'Active' : 'Inactive' ?> </td>
                          <td>
                            <a href="<?php echo base_url('/packages/edit/' . $item['id']) ?>" class="btn btn-info">Edit</a>
                            <a href="<?php echo base_url('/packages/delete/' . $item['id']) ?>" class="btn btn-danger">Delete</a>
                          </td>
                        </tr>
                      <?php $i++;
                      endforeach; ?>
