          ...
          <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="<?= site_url('/guides/update/' . $id)?>">
                      <div class="form-group">
                        <label for="exampleInputName1">Guide Name</label>
                        <input type="text" name="name" class="form-control" id="exampleInputName1" value="<?=$name?>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Designation</label>
                        <input type="text" name="designation" class="form-control" id="exampleInputEmail3" value="<?=$designation?>" >
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="status" class="form-control" id="exampleInputCity1" value="<?=$status?>">
                      </div>
